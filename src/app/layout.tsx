      ...
      <body>
        ...
        <header style={{
          ...
          <div className="container" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              <button style={{ color: '#fff', fontSize: '18px' }}>🔍</button>
              <Link href="/account" style={{ color: '#fff', fontSize: '14px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                ...
                <span style={{ 
                  ...
                  marginLeft: '-6px', marginTop: '-12px'
                }}>0</span>
              </Link>
              <Link href="/cart" style={{ color: '#fff', fontSize: '14px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                <span style={{ fontSize: '18px' }}>🛒</span>
                <span style={{ fontSize: '13px' }}>Rs. 0.00</span>
              </Link>
        ...
        <section style={{ padding: '60px 0', borderTop: '1px solid var(--color-border)' }}>
          <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
            {/* Social */}
            <div>
              <h3 style={{ fontSize: '20px', marginBottom: '24px', color: 'var(--color-text-main)' }}>
              ...
              <div style={{ display: 'flex', gap: '20px', marginBottom: '24px' }}>
                {['f', '𝕏', '▶', '◉'].map((icon, i) => (
                  <a key={i} href="#" style={{
                    ...
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: '16px', color: 'var(--color-text-main)',
            ...
            {/* Newsletter */}
            <div>
              <h3 style={{ fontSize: '20px', marginBottom: '8px', color: 'var(--color-text-main)' }}>
        ...
        <footer style={{ backgroundColor: 'var(--color-footer-bg)', padding: '60px 0 30px', color: '#ccc' }}>
          <div className="container" style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: '60px', marginBottom: '48px' }}>
            {/* Brand column */}
            <div>
